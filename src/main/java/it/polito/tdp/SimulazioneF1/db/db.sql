...
CREATE TABLE IF NOT EXISTS `drivers` (
  ...
  `ScuderiaNome` varchar(50) DEFAULT NULL,
  `Età` date DEFAULT NULL,
...
REPLACE INTO `drivers` (`Numero`, `Nome`, `Cognome`, `Nazionalità`, `ScuderiaID`, `ScuderiaNome`, `Età`, `GPs`, `Overall`, `Reactions`, `Control`, `Smoothness`, `Adaptabity`, `Overtaking`, `Defending`, `Aggressivity`) VALUES
	(1, 'Max', 'Verstappen', 'Olanda', 1, 'Red Bull Racing', '1997-09-30', NULL, 90.75, 88, 89, 88, 88, 91, 97, 70),
	(11, 'Sergio', 'Perez', 'Messico', 1, 'Red Bull Racing', '1990-01-26', NULL, 88.45, 93, 92, 84, 76, 92, 93, 53),
	(44, 'Lewis', 'Hamilton', 'Regno Unito', 2, 'Mercedes', '1985-01-07', NULL, 89.85, 86, 92, 86, 87, 90, 94, 57),
	(16, 'Charles', 'Leclerc', 'Monaco', 3, 'Ferrari', '1997-10-16', NULL, 89, 86, 89, 83, 81, 89, 91, 48),
	(14, 'Fernando', 'Alonso', 'Spagna', 5, 'Aston Martin', '1981-07-29', NULL, 89.65, 86, 94, 87, 86, 91, 91, 67),
	(22, 'Yuki', 'Tsunoda', 'Giappone', 8, 'AlphaTauri', '2000-05-11', NULL, 78.95, 81, 73, 78, 74, 81, 79, 85),
	(10, 'Pierre', 'Gasly', 'Francia', 6, 'Alpine', '1996-02-07', NULL, 86.15, 82, 93, 90, 95, 85, 84, 53),
	(55, 'Carlos', 'Sainz', 'Spagna', 3, 'Ferrari', '1994-09-01', NULL, 86.75, 86, 85, 79, 80, 89, 93, 38),
	(4, 'Lando', 'Norris', 'Regno Unito', 4, 'McLaren', '1999-11-13', NULL, 87.3, 84, 95, 94, 77, 85, 86, 57),
	(63, 'George', 'Russell', 'Regno Unito', 2, 'Mercedes', '1998-02-15', NULL, 87.4, 87, 88, 85, 96, 81, 88, 65),
	(18, 'Lance', 'Stroll', 'Canada', 5, 'Aston Martin', '1998-10-29', NULL, 83.05, 80, 85, 81, 93, 84, 85, 75),
	(31, 'Esteban', 'Ocon', 'Francia', 6, 'Alpine', '1996-09-17', NULL, 83.8, 82, 84, 83, 81, 83, 84, 51),
	(23, 'Alexander', 'Albon', 'Thailandia', 7, 'Williams', '1996-03-23', NULL, 80.55, 85, 83, 78, 83, 82, 85, 77),
	(77, 'Valtteri', 'Bottas', 'Finlandia', 9, 'Alfa Romeo', '1989-08-28', NULL, 86.25, 83, 91, 76, 73, 82, 88, 25),
	(3, 'Daniel', 'Ricciardo', 'Australia', 8, 'AlphaTauri', '1989-07-01', NULL, 83.05, 82, 87, 87, 79, 85, 83, 67),
	(20, 'Kevin', 'Magnussen', 'Danimarca', 10, 'Haas', '1992-10-05', NULL, 80.6, 83, 83, 78, 91, 79, 76, 53),
	(27, 'Nico', 'Hülkenberg', 'Germania', 10, 'Haas', '1987-08-19', NULL, 79.2, 84, 81, 77, 92, 75, 75, 26),
	(81, 'Oscar', 'Piastri', 'Australia', 4, 'McLaren', '2001-04-06', NULL, 75.65, 76, 82, 69, 80, 73, 75, 54),
	(24, 'Guanyu ', 'Zhou', 'Cina', 9, 'Alfa Romeo', '1999-05-30', NULL, 79.65, 80, 84, 79, 78, 81, 75, 67),
	(2, 'Logan', 'Sargeant', 'USA', 7, 'Williams', '2000-12-31', NULL, 73.1, 76, 74, 69, 75, 66, 71, 24);
...
-- Dump dei dati della tabella simulazionef1.overtake: ~13 rows (circa)
